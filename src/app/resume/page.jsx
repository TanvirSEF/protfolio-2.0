          ...
          <div className="min-h-[70vh] w-full">
                        ...
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger className="w-full h-[150px] bg-[#232329] rounded-xl flex justify-center items-center group">
                              <div className="text-6xl group-hover:text-hover transition-all duration-300 cursor-pointer">
                                {skill.icon}
                              </div>
                            </TooltipTrigger>
                            <TooltipContent>
            ...
            >
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 xl:grid-cols-2 gap-y-6 mx-w-[620px] mx-auto xl:mx-0">
